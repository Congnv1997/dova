          ...
          <div class="banner">
            ...
            <div class="vlt-anh">
              <div class="vlt-avatar load-anh">
                @if (Auth::check())
                <img
                  src="{{\Illuminate\Support\Facades\URL::to('public/upload/'.Auth::user()->logo)}}"
                  alt=""
                />
                @else @endif
              </div>
            ...
            <a href="" >
                ...
                <div class="vlt-anh">
                    <div class="vlt-avatar load-anh" >
                    @if (Auth::check())
                                    <img src="{{\Illuminate\Support\Facades\URL::to('public/upload/'.Auth::user()->logo)}}" alt="">
                                @else
                                @endif
                    </div>
  ...
  <div class="vlt-right col-md-2">
    <section class="panel panel-primary vlt-menuleft">
      ...
      <div class="panel-body panel-body-full vlt-scrollin4">
        <div id="ctl21_list_chuongtrinh" class="list-group no-radius">
          <a
          ...
          <a
            ...
            data-toggle="modal"
            data-target="#modalCourse"
            >Tiếng Anh cấp 2 nhóm cô Minh</a
          >
          <a
            class="list-group-item"
            href="#"
      ...
      <div class="panel-body panel-body-full">
        <div class="list-group no-radius alt">
          <a
            class="list-group-item no-b-t"
            href="#"
            data-toggle="modal"
            data-target="#modalAnalyticSmall"
          >
