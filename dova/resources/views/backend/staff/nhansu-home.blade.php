                            ...
                            <div class="statistic">
                                <div class="row">
                                    <div class="col-lg-4 col-md-6 m-t text-center btn-manager">
                                        <a href="{{\Illuminate\Support\Facades\URL::to('/staff')}}" class="block padder-v hover">
                                    ...
                                    <div class="col-lg-4 col-md-6 m-t text-center btn-manager">
                                        <a target="_bank" href="nhan-su/thong-ke" class="block padder-v hover">
                                            <span class="i-s i-s-2x">
                                    ...
                                    <div class="col-lg-4 col-md-6 m-t text-center btn-manager">
                                        <a target="_bank" href="nhan-su/cham-cong" class="block padder-v hover">
                                            <span class="i-s i-s-2x">
                                    ...
                                    <div class="col-lg-4 col-md-6 m-t text-center btn-manager">
                                        <a href="{{\Illuminate\Support\Facades\URL::to('bo-phan')}}" class="block padder-v hover">
                                            <span class="i-s i-s-2x">
                                                <i class="i i-hexagon2 i-s-base text-success-lt hover-rotate"></i>
                                                <i class="fa fa-list text-white"></i>
                                            </span>
                                            <span class="clear">
                                                <span class="h3 block m-t-xs text-warning">bộ phận</span>
                                                <small class="text-muted text-u-c">Tất cả bộ phận</small>
                                            </span>
                                        </a>
                                    </div>
