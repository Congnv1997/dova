    ...
    <style>
        ...
        <div class="project-list">
            ...
            <div class="project-page-title">
                <h1 style="color:#3578E5; font-weight:700;text-align: center">DỰ ÁN ĐANG THỰC HIỆN</h1>
            </div>
            <div style="position: relative" class="container">
                ...
                <div class="project-item col-sm-3" style="background-color: #fff;border: none;border-radius: 35px;margin: 18px; position: flex; justify-content: space-between">
                    ...
                    <div class="project-time-start">
                        <p>Bắt đầu: {{ $on -> time_start }}</p>
                    </div>                        
                    <div class="project-deadline">
                         <p>Dự kiến kết thúc: {{ $on -> deadline }}</p>  
                    </div>    
                    <div class="project-main-content">  
                        <p>Nội dung dự án: <br> {{ $on -> content }}</p>
