          ...
          <div class="row login-block">
            <div class="col-md-4 inp-email remove-padding-left">
              <form method="post" action="{{route('Auth.Login')}}">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="admin_email" class="form-control" id="inpEmail" name="admin_email" placeholder="email hoặc sđt" />
                </div>
                @if ($errors->has('email'))
            ...
            <div class="col-md4 inp-pass remove-padding-left">
              <div class="form-group">
                ...
                <input type="password" class="form-control" id="inpPass" name="admin_password" placeholder="nhập mật khẩu" />
              </div>
