 ...
 <?php if(session('toastr')): ?>
    ...
    <div class="modal fade" id="modal-suathongtincanhan">
         <div class="modal-dialog modal-lg">
          ...
          <?php echo $__env->make('layout.main.header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
          <?php echo $__env->make('layout.main.banner', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

         <?php echo $__env->make('layout.main.menu', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
function editthongtincanhan(ns) {
   ...
   $.ajax({
       ...
       success: function(data) {
        ...
        $("#form-suathongtincanhan #img_cu").attr('src','<?php echo e(url("")); ?>/upload/'+data.ns.logo);
