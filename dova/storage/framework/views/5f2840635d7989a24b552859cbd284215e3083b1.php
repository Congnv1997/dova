      ...
      <nav class="vlt-menutop">
        ...
        <li class="dropdown">
            <a href="#" class="dropdown-toggl  vlt-colorbanner" data-toggle="dropdown">
                ...
                <span class="thumb-sm avatar pull-left load-anh1">
                <?php if(Auth::check()): ?>
               ...
               <span id="menu_top_namelogin" class="load-name"><?php if(Auth::check()): ?>
                                    <h2><?php echo e(Auth::user()->name); ?></h2>
                                <?php else: ?>
                                <?php endif; ?></span><b class="caret"></b>
            </a>
            <ul class="dropdown-menu animated fadeInRight">
                 <li>
                    <span class="arrow top"></span>
                    <a href="#" onclick="event.preventDefault();editmatkhau(<?php if(Auth::check()): ?>
                                    <h2><?php echo e(Auth::user()->id); ?></h2>
                                <?php else: ?>
                                <?php endif; ?>)">Đổi Mật Khẩu</a>
                </li>
                <li>
                    <span class="arrow top"></span>
                    <a href="#" onclick="event.preventDefault();editthongtincanhan(<?php if(Auth::check()): ?>
                                    <h2><?php echo e(Auth::user()->id); ?></h2>
                                <?php else: ?>
                                <?php endif; ?>)">Thay đổi thông tin</a>
                </li>
                <li>
                    <span class="arrow top"></span>
                    <a href="dang-nhap/thoat">Thoát</a>
                </li>
            </ul>
        </li>
    </ul>
