...
$idname=$_GET['id'];
$sql = "SELECT id, title, start, end, color FROM events where iduser='$idname' ";
...
if (isset($_POST['addevent'])) {
	...
	$sql = "INSERT INTO events(title, start, end, color, iduser) values ('$title', '$start', '$end', '$color','$iduser')";
	//$req = $bdd->prepare($sql);
	//$req->execute();
...
<!-- <body> -->
    ...
    <!-- Page Content -->
<?php $sql="SELECT * FROM user where ID='$idname'";
